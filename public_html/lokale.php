<HTML>
    <HEAD>
        ...
        <?PHP
            ...
            $gm_id = $_GET['id'];
            $stmt = oci_parse($conn, "SELECT * FROM lokal WHERE id_gminy = $gm_id");

            oci_execute($stmt, OCI_NO_AUTO_COMMIT);

            $tmp = oci_parse($conn, "SELECT nazwa FROM gmina WHERE id = $gm_id");
                ...
                <table>
                    ...
                    <?PHP
                        ...
                        while ($row = oci_fetch_array($stmt, OCI_BOTH)) {
                            echo "<tr>";
                            echo "<th>".$num."</th>";
                            echo "<th><a href=\"wyniki.php?id=".$row['ID']."\">".$row['SIEDZIBA']."</a></th>";
                            echo "</tr>";
                            $num++;
                        }
                    ?>
